...
class Place(models.Model):
    ...
    rating = models.FloatField(null=True, blank=True, validators=[MinValueValidator(0), MaxValueValidator(5)], verbose_name="Rating")
    num_reviews = models.IntegerField(null=True, blank=True, verbose_name="Number of Reviews")
    ...
    full_address = models.CharField(max_length=512, blank=True, verbose_name="Full Address")
    address = models.CharField(max_length=250, blank=True, verbose_name="Street Address")
    located_in = models.CharField(max_length=250, null=True, blank=True, verbose_name="Located In")
    postcode = models.CharField(max_length=250, null=True, blank=True, verbose_name="Postcode")
    ...
    phone = models.CharField(
        ...
        null=True,
        blank=True,
        validators=[RegexValidator(r"^\+?\d{10,15}$", message="Invalid phone number")],
        verbose_name="Phone Number",
    )
    email = models.EmailField(null=True, blank=True, verbose_name="Email Address")

    website = models.URLField(null=True, blank=True, verbose_name="Website", validators=[URLValidator()])
    clear_website = models.CharField(max_length=250, null=True, verbose_name="Website Domain")

    facebook = models.CharField(null=True, blank=True, verbose_name="Facebook")
    instagram = models.CharField(null=True, blank=True, verbose_name="Instagram")
    linkedin = models.CharField(null=True, blank=True, verbose_name="LinkedIn")
    youtube = models.CharField(null=True, blank=True, verbose_name="YouTube")
    twitter = models.CharField(null=True, blank=True, verbose_name="Twitter")
